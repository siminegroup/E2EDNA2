...
class opendna:
    ...
    def setup(self):
        ...
        elif self.actionDict['do MMB'] is True:
    ...
    def getSecondaryStructure(self, aptamerSeq):
        ...
        if self.params['secondary structure engine'] == 'seqfold':
            ...
            nup = interfaces.nupack(aptamerSeq, self.params['temperature'], self.params['ionicStrength'], self.params['[Mg]'], stacking='nostacking')  # initialize nupack
