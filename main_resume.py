...
if params['device'] == 'cluster':
    ...
    params['ionicStrength'] = 0.163  # Molar - sodium concentration - used to predict secondary structure and add ions to simulation box, must be 1100 M > [Na] > 50 for nupack to run    
...
if params['device'] == 'local':
    params['workdir'] = '/Users/taoliu/PycharmProjects/myOpenDNA/TestResume/mcKeague/runs'
    ...
    params['workdir'] = '/home/taoliu/scratch/mcKeague/explicitSolvent/runs'
