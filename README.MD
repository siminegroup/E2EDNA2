...
4. From e2edna folder run macos_installation.sh. Caveat: in case conda activate command doesn't not work, please try replacing with source activate path-to-env
