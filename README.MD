...
4. From E2EDNA2 folder run [``macos_installation.sh``](https://github.com/InfluenceFunctional/E2EDNA2/blob/main/macos_installation.sh) in your command line by ``source macos_installation.sh``
