...
Running this script [automate_tests.sh](https://github.com/siminegroup/E2EDNA2/blob/JOSS/automate_tests.sh) will automatically run light simulations of all 8 modes.
