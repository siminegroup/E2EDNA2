...
run_info.add_argument('--ensemble',
                         metavar='\b',
                         type=str,
                         default='nostacking',
                         help='How NUPACK4 handles the stacking calculations',
                         choices=['nostacking', 'stacking', 'none-nupack3', 'some-nupack3', 'all-nupack3'])
