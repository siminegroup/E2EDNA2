...
printf "\t2d structure: in record.txt\n"
printf "\tMMB-folded aptamer structure: foldedAptamer_0.pdb\n"
printf "\tShort MD relaxation trajectory of free aptamer: foldedAptamer_0_processed_trajectory.dcd or clean_foldedAptamer_0_processed_trajectory.dcd (without solvent and ions)\n"
...
printf "\t2d structure: in record.txt\n"
printf "\tMMB-folded aptamer structure: foldedAptamer_0.pdb\n"
printf "\tLong MD sampling trajectory of free aptamer: foldedAptamer_0_processed_complete_trajectory.dcd or clean_foldedAptamer_0_processed_complete_trajectory.dcd (without solvent and ions)\n"
...
printf "\tRepresentative structure of free aptamer: repStructure_0.pdb\n"
printf "\tRepresentative aptamer docked by target ligand: complex_0_0.pdb (if docking happened)\n"
printf "\tLong MD sampling trajectory of aptamer-ligand complex: complex_0_0_processed_complete_trajectory.dcd or clean_complex_0_0_processed_complete_trajectory.dcd (without solvent and ions)\n"
printf "====================================\n"
